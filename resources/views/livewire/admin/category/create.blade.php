<div>
    ...
    <div class="page-header">
        <div style="display:flex; align-items:center; gap:12px; margin-bottom:4px;">
            ...
            <h1 class="page-title">TAMBAH <span class="accent">KATEGORI</span></h1>
        </div>
        <p class="page-subtitle">Tambahkan kategori baru untuk mengorganisir menu</p>
    </div>
        ...
        <div class="card-hard animate-fade-up">
            ...
            <div style="display:flex; flex-direction:column; gap:20px;">
                ...
                <div class="form-group">
                    ...
                    @enderror
                    <span class="form-hint">Nama akan tampil di katalog menu pelanggan.</span>
                </div>
