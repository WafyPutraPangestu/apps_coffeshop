<div>
    ...
    <div class="page-header">
        <div style="display:flex; align-items:center; gap:12px; margin-bottom:4px;">
            ...
            <h1 class="page-title">EDIT <span class="accent">MENU</span></h1>
        </div>
        <p class="page-subtitle">Perbarui informasi menu · ID #{{ $menuId }}</p>
    </div>
    ...
    <div style="display:grid; grid-template-columns:1fr 340px; gap:20px; align-items:start; max-width:900px;">
        ...
        <div class="card-hard animate-fade-up">
            ...
            <div
                ...
                <div style="display:flex; align-items:center; gap:8px;">
                    ...
                    <span
                        style="font-family:var(--font-mono); font-size:10px; text-transform:uppercase; letter-spacing:0.14em; color:#fff;">Edit
                        Data</span>
                </div>
                <span style="font-family:var(--font-mono); font-size:10px; color:var(--color-ink-600);">ID
                    #{{ $menuId }}</span>
            </div>
        ...
        <div class="card-hard animate-fade-up" style="margin-top:20px;">
            ...
            @if ($addOns->count() > 0)
                ...
                <span class="form-hint" style="margin-top:10px; display:block;">
                    Centang/hapus add-on untuk menyesuaikan menu ini.
                </span>
            @else
        ...
        <div style="display:flex; flex-direction:column; gap:16px;">
            ...
            <div class="card-hard animate-fade-up stagger-1">
                ...
                @if ($image)
                    <div
                        style="margin-bottom:12px; border-radius:var(--radius-md); overflow:hidden; border:1px solid var(--color-lime-600); aspect-ratio:4/3; background:var(--color-ink-900); position:relative;">
                        <img src="{{ $image->temporaryUrl() }}" alt="Preview"
                            style="width:100%; height:100%; object-fit:cover;" />
                        <span
                            style="position:absolute; top:8px; right:8px; background:var(--color-lime-500); color:var(--color-ink-950); font-family:var(--font-mono); font-size:9px; font-weight:700; padding:2px 8px; border-radius:var(--radius-sm); letter-spacing:0.08em;">BARU</span>
                    </div>

                    {{-- Preview gambar lama --}}
                @elseif($existingImage)
                    <div
                        style="margin-bottom:12px; border-radius:var(--radius-md); overflow:hidden; border:1px solid var(--color-ink-600); aspect-ratio:4/3; background:var(--color-ink-900); position:relative;">
                        <img src="{{ asset('storage/' . $existingImage) }}" alt="Gambar saat ini"
                            style="width:100%; height:100%; object-fit:cover;" />
                        <button wire:click="removeImage"
                            style="position:absolute; top:8px; right:8px; background:var(--color-error-bg); border:1px solid var(--color-error); color:var(--color-error); width:24px; height:24px; border-radius:var(--radius-sm); display:flex; align-items:center; justify-content:center; cursor:pointer;"
                            title="Hapus gambar">
            ...
            <div class="card-hard animate-fade-up stagger-2">
                <div
                    ...
                    <span
                        style="font-family:var(--font-mono); font-size:10px; text-transform:uppercase; letter-spacing:0.14em; color:#fff;">Status</span>
                </div>
